...
# ==========================================
# 1. DATABASE SPESIFIKASI (Hardcoded dari Gambar Skripsi)
# ==========================================

SERVER_TYPES_SPEC = [
	{'id': 1, 'cpu': 40, 'mem': 80, 'pc_idle': 60, 'pc_max': 100, 'bw': 10},
	{'id': 2, 'cpu': 60, 'mem': 120, 'pc_idle': 120, 'pc_max': 200, 'bw': 10},
	{'id': 3, 'cpu': 80, 'mem': 160, 'pc_idle': 180, 'pc_max': 300, 'bw': 10},
	{'id': 4, 'cpu': 100, 'mem': 200, 'pc_idle': 240, 'pc_max': 400, 'bw': 25},
	{'id': 5, 'cpu': 120, 'mem': 240, 'pc_idle': 300, 'pc_max': 500, 'bw': 25},
	{'id': 6, 'cpu': 140, 'mem': 280, 'pc_idle': 360, 'pc_max': 600, 'bw': 40},
	{'id': 7, 'cpu': 160, 'mem': 320, 'pc_idle': 420, 'pc_max': 700, 'bw': 40},
	{'id': 8, 'cpu': 180, 'mem': 360, 'pc_idle': 480, 'pc_max': 800, 'bw': 100},
	{'id': 9, 'cpu': 200, 'mem': 400, 'pc_idle': 540, 'pc_max': 900, 'bw': 100},
	{'id': 10, 'cpu': 220, 'mem': 440, 'pc_idle': 600, 'pc_max': 1000, 'bw': 100},
]
...
def generateProblem(filename, scenario_name, seed_value):
	...
	k, servers_per_rack, racks_per_pod = _calculate_fattree_topology(num_servers)
	...
	for cluster_id, vm_list in clusters.items():
		...
		if sum_T_in == 0: continue

		for vm_1 in vm_list:
			for vm_2 in vm_list:
				if vm_1 == vm_2: continue
				# Gravity Model
	...
	for vm_1 in range(num_vms):
		for vm_2 in range(vm_1 + 1, num_vms):
			# Symmetrization
			total_traffic = T_matrix_directed[vm_1][vm_2] + T_matrix_directed[vm_2][vm_1]
	...
	for server_1 in range(num_servers):
		...
		for server_2 in range(num_servers):
			C_matrix[server_1][server_2] = getFatTreeCost(server_1, server_2, servers_per_rack, racks_per_pod)
